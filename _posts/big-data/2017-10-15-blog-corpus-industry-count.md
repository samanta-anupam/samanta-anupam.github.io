...
## Getting all Industry Names<a name="industry-names"></a>
---

### Analysing the task<a name="analyse-task"></a>
...
### Reading the dataset<a name="read-dataset"/>
...
### Broadcasting set of Industries<a name="broadcast-industry"></a>
...
## Counting Industry mentions over months<a name="count-industry"></a>
---

### Analysing the file content<a name="analyse-file"></a>
...
### Cleaning file content<a name="clean-file"></a>
...
### Counting Industry and the dates when they were mentioned<a name="count-month"></a>
...
### Applying on Spark<a name="apply-spark"></a>
